...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Assessing a management procedure for a benthic species with non-annual recruitment, the case of the surf clam Mesodesma donacium in northern Patagonia, Chile.},
            pdfborder={0 0 0},
            breaklinks=true}
